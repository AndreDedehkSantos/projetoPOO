 ...
 * @author andre
 */
public class PesquisarPrestadorView extends javax.swing.JFrame {

    /**
     * Creates new form MainView
     */
    public PesquisarPrestadorView() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Pesquisar Prestador");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(txtEmpresa, javax.swing.GroupLayout.PREFERRED_SIZE, 218, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        PrestadorController.excluirPrestador(cpf);
        txtNome.setText("");
        txtCpf.setText("");
        txtEmpresa.setText("");
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        PrestadorController.alterarPrestador(categoria, empresa, cpfMorador, nome, cpf, ultimoAcesso);
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        String cpf = txtCpf.getText();
        Prestador prestador = PrestadorController.pesquisarPrestador(cpf);
        if(prestador != null){
            txtNome.setText(prestador.getNome());
            txtCpfMorador.setText(prestador.getCpfMorador());
            txtEmpresa.setText(prestador.getEmpresa());
            txtCategoria.setText(prestador.getCategoria());
            txtUltimoAcesso.setText(prestador.getUltimoAcesso());
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesquisarPrestadorView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
