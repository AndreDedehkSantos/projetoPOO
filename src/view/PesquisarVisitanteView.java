...
public class PesquisarVisitanteView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Pesquisar Visitante");
        ...
        cbTipo.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        cbTipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione", "PARENTE", "AMIGO", "PARCEIRO", "OUTRO" }));
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(txtCpfMorador, javax.swing.GroupLayout.PREFERRED_SIZE, 244, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        if(t.equals("Selecione")){
            JOptionPane.showMessageDialog(null, "Escolha um Tipo de Visitante");
        }else{
            VisitanteController.alterarVisitante(cpfMorador, tipo, nome, cpf, data);
        } 
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        String cpf = txtCpf.getText();
        Visitante visitante = VisitanteController.pesquisarVisitante(cpf);
        if(visitante != null){
            txtNome.setText(visitante.getNome());
            txtCpfMorador.setText(visitante.getMorador());
            switch(visitante.getTipo().toString()){
            case("PARENTE"):
                cbTipo.setSelectedItem("PARENTE");
                break;
            case("AMIGO"):
                cbTipo.setSelectedItem("AMIGO");
                break;
            case("PARCEIRO"):
                cbTipo.setSelectedItem("PARCEIRO");
                break;
            case("OUTRO"):
                cbTipo.setSelectedItem("OUTRO");
                break;
            default:
                break;
            }
            txtUltimoAcesso.setText(visitante.getUltimoAcesso());
        }
